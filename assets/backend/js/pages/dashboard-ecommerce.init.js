...
var worldlinemap, overlay, options, chart, linechartcustomerColors = getChartColorsArray("customer_impression_charts"),
    chartDonutBasicColors = (linechartcustomerColors && (options = {
        ...
        stroke: {curve: "straight", dashArray: [0, 0, 8], width: [.1, 0, 2]},
        fill: {opacity: [.03, .9, 1]},
        ...
        plotOptions: {bar: {columnWidth: "20%", barHeight: "100%", borderRadius: [8]}},
    ...
    layoutRightSideBtn = (vectorMapWorldLineColors && (worldlinemap = new jsVectorMap({
        ...
        }, {name: "Brazil", coords: [-14.235, -51.9253]}, {name: "Serbia", coords: [44.0165, 21.0059]}, {
            name: "Russia",
            coords: [61, 105]
        }, {name: "China", coords: [35.8617, 104.1954]}, {
            name: "United States",
            coords: [37.0902, -95.7129]
        }, {name: "Norway", coords: [60.472024, 8.468946]}, {name: "Sydney", coords: [33.8688, 151.2093]}],
        lines: [{from: "Canada", to: "Serbia"}, {from: "Russia", to: "Serbia"}, {
            from: "Greenland",
            to: "Serbia"
        }, {from: "Brazil", to: "Serbia"}, {from: "United States", to: "Serbia"}, {
            from: "China",
            to: "Serbia"
        }, {from: "Norway", to: "Serbia"}, {from: "Sydney", to: "Serbia"}],
        regionStyle: {initial: {stroke: "#9599ad", strokeWidth: .25, fill: vectorMapWorldLineColors, fillOpacity: 1}},
        labels: {
            markers: {
                render(e, t) {
...
chartRadialbarMultipleColors && (options = {
    ...
    legend: {show: !0, fontSize: "16px", position: "bottom", labels: {useSeriesColors: !0}, markers: {size: 0}}
}, (chart = new ApexCharts(document.querySelector("#multiple_radialbar"), options)).render()), document.querySelectorAll(".chat-panel-list li").forEach(function (r) {
    r.addEventListener("click", function () {
        ...
        var e = r.querySelector(".chatlist-user-name").innerHTML,
            ...
            e = (document.querySelector(".chat-topbar .profile-username").innerHTML = e, document.querySelector(".chat-topbar .userprofile").setAttribute("src", t), document.getElementById("users-conversation"));
...
var forms = document.querySelectorAll(".chat-form"), chatInput = document.getElementById("chat-input"),
...
scrollToBottom(currentChatId), deleteMessage();
...
searchInput.addEventListener("keyup", function () {
    ...
    0 < e ? (a = searchInput.value.toLowerCase(), Array.from(t).forEach(function (e) {
        var t, r, o = "";
        e.querySelector(".chatlist-user-name") ? (t = e.querySelector(".chatlist-desc").innerText.toLowerCase(), o = (r = e.querySelector(".chatlist-user-name").innerText.toLowerCase()).includes(a) ? r : t) : e.querySelector(".chatlist-desc") && (o = e.querySelector(".chatlist-desc").innerText.toLowerCase()), console.log(o), o && (o.includes(a) ? (e.classList.add("d-block"), e.classList.remove("d-none")) : (e.classList.remove("d-block"), e.classList.add("d-none")))
